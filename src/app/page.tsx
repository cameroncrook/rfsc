        ...
        <div className="bg-gray-100">
          ...
          <section className="py-20" id="sponsors">
            <div className="container mx-auto px-6">
              ...
              <div className="text-center">
                <Link href="/gallery" className="mt-8 inline-block bg-primary/90 text-white px-6 py-3 rounded-full hover:bg-primary transition-colors text-lg font-semibold shadow-lg">View Full Gallery</Link>
              </div>
            </div>
          </section>
        </div>
