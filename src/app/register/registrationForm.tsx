    ...
    return <form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className={`${styles.formSection}`}>
                ...
                <div className={`${styles.inputGroup}`}>
                    ...
                    <input className={`${styles.formInput}`} id="p2_first_name" name="p2_first_name" type="text" required />
                </div>
                <div className={`${styles.inputGroup}`}>
                    <label className={`${styles.inputLabel}`} htmlFor="p2_last_name">Last Name</label>
                    <input className={`${styles.formInput}`} id="p2_last_name" name="p2_last_name" type="text" required />
                </div>
                <div className={`${styles.inputGroup}`}>
                    <label className={`${styles.inputLabel}`} htmlFor="p2_email">Email</label>
                    <input className={`${styles.formInput}`} id="p2_email" name="p2_email" type="email" required />
                </div>
                <div className={`${styles.inputGroup}`}>
                    <label className={`${styles.inputLabel}`} htmlFor="p2_phone">Phone</label>
                    <input className={`${styles.formInput}`} id="p2_phone" name="p2_phone" type="tel" required />
                </div>
            </div>
        </div>
        ...
        <div className={`${styles.formSection}`}>
            ...
            <div className={`${styles.inputGroup}`}>
                ...
                <input className={`${styles.formInput}`} id="emergency_name" name="emergency_name" type="text"/>
            </div>
        ...
        <div className={`${styles.formSection}`}>
            ...
            <div className={`${styles.inputGroup} mt-6`}>
                ...
                <input className={`${styles.formInput}`} id="signature" name="signature" type="text" />
            </div>
        </div>
